...
That is the finding. The skills automate what that exercise proves. The difference between the response your agent gives without seeing its thoughts, and the response it gives after — that gap is what this project measures.
